  ...
  <>
    <Section row nopadding id="home">
      <LeftSection>
        ...
        <SectionText>
        I am a graduate currently doing Honours in Computer Sciences with the hunger to gain experience in the software development industry. 
        I am a Confident, Honourable and Loving person. Software development is my passion and I love exploring new technologies.
        </SectionText>
        <SectionText>
            I want to be a developer at <b>SovTech</b> because I want to learn from the best #WORLDCLASS. I read the company’s mission and vision. After finding out
